...
//create Enemy object
var enemyBug1 = new Enemy(0, 60, Math.floor(Math.random() * 250));
var enemyBug2 = new Enemy(0, 145, Math.floor(Math.random() * 250));
var enemyBug3 = new Enemy(0, 230, Math.floor(Math.random() * 250));
